# -*- coding: utf-8 -*-
"""This module performs a complete computation scheme: irradiance absorption, gas-exchange, hydraulic structure,
...
def run(g: MTG, wd: Path, params: dict = None, scene: Scene = None, write_result: bool = True, path_output: Path = None,
        is_save_mtg: bool = False, grape_vid: int = None, **kwargs) -> DataFrame:
    ...
    for date in params.simulation.date_range:
        ...
        if grape_vid is not None:
            psi_grape_ls.append(g.node(grape_vid).psi_head)
